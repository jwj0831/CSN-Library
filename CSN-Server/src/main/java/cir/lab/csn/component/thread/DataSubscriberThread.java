...
public class DataSubscriberThread extends Thread implements MqttCallback {
    Logger logger = LoggerFactory.getLogger(DataSubscriberThread.class);
    ...
    public DataSubscriberThread(String name, BlockingQueue queue) {
        super(name);
        this.queue = queue;
