...
public class Receiver3 implements MqttCallback {
    ...
    public Receiver3() {
        try {
            bw = new BufferedWriter(new FileWriter("rcv3.csv"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        ...
        msgCount++;
        System.out.println("[RCV3] Subscribed MSG " + msgCount + " : " + data);
        stopWatch.split();
